...
class SQLiteStorage {
        ...
        final database = await openDatabase(
            ...
            onCreate: (db, version) {
                db.execute('''
                    ...
                    CREATE TABLE IF NOT EXISTS ${biaTable.table} (
                    ...
                    CREATE TABLE IF NOT EXISTS ${currentUserTable.table} (${currentUserTable.userId});
                ''');
            },
        );
    ...
    Future<Result<UserSQLiteModel>> updateUser(int id, UserSQLiteModel newData) async {
        final db = await database;
