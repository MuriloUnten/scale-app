...
import "package:scale_app/ui/main_screen.dart";
...
GoRouter router() => GoRouter(
    ...
    routes: [
      ...
      GoRoute(
          ...
          builder: (context, state) {
            final viewModel =
                CreateUserViewmodel(userRepository: context.read());
      ...
      GoRoute(
          ...
          builder: (context, state) {
            final viewModel =
                SelectUserViewmodel(userRepository: context.read());
      ...
      GoRoute(
        ...
        builder: (context, state) {
          final viewModel =
              UserProfileViewmodel(userRepository: context.read());
    ...
    redirect: (context, state) async {
      final loggingIn = state.matchedLocation == "/create-user" ||
          state.matchedLocation == "/select-user";
      if (loggingIn) {
        return null;
      }
